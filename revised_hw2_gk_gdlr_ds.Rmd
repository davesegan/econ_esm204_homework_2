...
total_abate_Y_fx <- function(abatement){total_ab_Y_p_coeff * abatement + total_ab_Y_p_const} 
...
d_Y_diff <- integrate(d_supply, d_Y_quant, 300 - d_Y_quant)$value ##### I dunno if this is right

a_total_Y <- a_Y_cost + a_Y_diff # This SHOULD be the new cost to each sector, unsure for D
